    ...
    <Box textAlign="center">
      <form onSubmit={sendEmail}>
        ...
        <TextField
          label="Контакты"
          name="contacts"
          helperText="Ссылка на ВК, телефон или почта"
          margin="normal"
        />
        <br />
        ...
        <Collapse in={open}>
          ...
          <Button onClick={setChecked}>
            Я подтверждаю, что ознакомился с правилами, и буду их соблюдать
          </Button>
        </Collapse>
        <Collapse in={checked}>
          <Typography variant="h6">
            При первом входе, вы должны установить желаемый пароль
          </Typography>
          <br />
          <Typography variant="h6">
            Ни администраторы ТРЮМа, ни системные администраторы не будут знать
            данные от вашего аккаута
          </Typography>
